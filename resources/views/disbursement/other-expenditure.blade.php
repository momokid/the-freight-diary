...
@section('title', 'Other Expenditure - Admin')
@section('page-title', 'Other Expenditure - Admin')
...
@section('content')
    ...
    <div style="display: flex; flex-direction: column; gap: 1.25rem; max-width: 90vw;">
        ...
        <div class="card">
            <p class="form-title">Expenditure Transaction</p>
            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 1rem; margin-top: 1rem;">
                ...
                <div class="form-group" style="margin-bottom: 0;">
                    ...
                    <input type="text" id="description" class="form-input"
                        placeholder="e.g. Admin expense for consignment processing" maxlength="500">
...
@push('scripts')
    <script>
        ...
        const ROUTES = {
            search: '{{ route('disbursement.other-expenditure.search') }}',
            save: '{{ route('disbursement.other-expenditure.save') }}',
        };
        ...
        function initSearch() {
            window.blSearch = new SearchDropdown({
                ...
                minLength: 2,
                onSelect: (bl, label) => {
                    // Find full item from last results — store via data attribute trick
            ...
            // Hook into the search to cache results
        ...
        function populateMeta(item) {
            ...
            document.getElementById('meta-consignee').textContent = item.CommodityType ?? '—';
            ...
            if (!descEl.value) {
                descEl.value = `ADMIN EXPENDITURE IFO ${item.BL}`;
            }
        }
        ...
        function saveTransaction() {
            ...
            if (!accountNo) {
                showError('account-error', 'Please select an expenditure account.');
                valid = false;
            }
            if (!cashAccount) {
            ...
            fetch(ROUTES.save, {
                ...
                .catch(err => {
                    console.error('Other expenditure save error:', err);
