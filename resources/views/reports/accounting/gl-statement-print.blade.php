...
<body>
    ...
    <div class="summary-strip">
        ...
        <div class="stat-card">
            ...
            <div class="stat-val {{ $data['openingBalance'] >= 0 ? 'bal-pos' : 'bal-neg' }}">
                GH₵ {{ number_format($data['openingBalance'], 2) }}
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-label">Total Dr</div>
            <div class="stat-val">GH₵ {{ number_format($data['totalDr'], 2) }}</div>
        </div>
        <div class="stat-card">
            <div class="stat-label">Total Cr</div>
            <div class="stat-val">GH₵ {{ number_format($data['totalCr'], 2) }}</div>
        </div>
        <div class="stat-card">
            <div class="stat-label">Closing Balance</div>
            <div class="stat-val {{ $data['closingBalance'] >= 0 ? 'bal-pos' : 'bal-neg' }}">
    ...
    <script>
        window.exportReport = function() {
            ...
            window.location.href = '{{ route('reports.accounting.gl-statement.export') }}?' + params.toString();
        };
    </script>
</body>
