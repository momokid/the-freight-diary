...
<body>
    ...
    <div class="summary-strip">
        ...
        <div class="stat-card stat-red">
            <div class="stat-label">Total Expenditure (Dr)</div>
            <div class="stat-val" style="font-size:13px;">GH₵ {{ number_format($data['totalDr'], 2) }}</div>
        </div>
        <div class="stat-card {{ $data['closingBalance'] >= 0 ? 'stat-blue' : 'stat-red' }}">
        ...
        <tbody>
            ...
            @forelse ($data['transactions'] as $tx)
                <tr>
                    ...
                    <td class="r" style="color:#b91c1c;">{{ $tx->Dr > 0 ? number_format($tx->Dr, 2) : '—' }}</td>
                    <td class="r">{{ $tx->Cr > 0 ? number_format($tx->Cr, 2) : '—' }}</td>
            ...
            <tr class="closing-row">
                ...
                <td class="r" style="color:#b91c1c;">{{ number_format($data['totalDr'], 2) }}</td>
                <td class="r">{{ number_format($data['totalCr'], 2) }}</td>
    ...
    <script>
        window.exportReport = function() {
            ...
            window.location.href = '{{ route('reports.accounting.expenditure-statement.export') }}?' + params
            .toString();
        };
    </script>
</body>
