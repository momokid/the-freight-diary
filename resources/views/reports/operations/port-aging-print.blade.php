...
<body>
    ...
    {{-- ── Summary strip 2: Age brackets ── --}}
    <p class="summary-strip-label">By Age (from ETA)</p>
    <div class="summary-strip" style="margin-bottom:16px;">
        <div class="stat-card stat-fresh">
            <div class="stat-label">Fresh (0–7 days)</div>
            <div class="stat-val">{{ $ageSummary['fresh'] }}</div>
        </div>
        <div class="stat-card stat-warning">
            <div class="stat-label">Warning (8–14 days)</div>
            <div class="stat-val">{{ $ageSummary['warning'] }}</div>
        </div>
        <div class="stat-card stat-critical">
            <div class="stat-label">Critical (15–30 days)</div>
            <div class="stat-val">{{ $ageSummary['critical'] }}</div>
        </div>
        <div class="stat-card stat-overdue">
            <div class="stat-label">Overdue (30+ days)</div>
            <div class="stat-val">{{ $ageSummary['overdue'] }}</div>
        </div>
        <div class="stat-card stat-gray">
            <div class="stat-label">Total</div>
            <div class="stat-val">{{ $ageSummary['total'] }}</div>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="r" style="width:5%">Date Reg.</th>
        ...
        @if ($rows->isNotEmpty())
            <tfoot>
                <tr class="totals-row">
                    ...
                    <td colspan="4">
                        <span class="totals-badge totals-lcl">LCL: {{ $lclCount }}</span>
                        <span class="totals-badge totals-fcl">FCL: {{ $fclCount }}</span>
                    </td>
                </tr>
            </tfoot>
        @endif
    ...
    <script>
        window.exportReport = function() {
            ...
            window.location.href = '{{ route('reports.operations.port-aging.export') }}?' + params.toString();
        };
    </script>
