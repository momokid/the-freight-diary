...
<head>
    ...
    <title>Consignment Status Summary</title>
    <style>
        * {
...
<body>
    ...
    <div class="rpt-header">
        ...
        <div class="rpt-meta-block">
            <p class="rpt-title">Consignment Status Summary</p>
    ...
    <script>
        window.exportReport = function() {
            ...
            window.location.href = '{{ route('reports.operations.consignment-status.export') }}?' + params.toString();
        };
    </script>
