...
<head>
    ...
    <title>Declaration Receipt — {{ $declaration->ReceiptNo }}</title>
    <style>
        * {
    ...
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <div class="header-info">
                ...
                <div class="tagline">Custom Brokers, Consolidation, Sea &amp; Air Freight, Clearing &amp;<br>Forwarding,
                    Transit, Haulage, Import &amp; Export</div>
            </div>
        </div>

        {{-- Banner --}}
        <div class="banner">DECLARATION RECEIPT</div>

        {{-- Receipt meta --}}
        <div class="meta-row">
            <div><strong>Date:</strong> {{ \Carbon\Carbon::parse($declaration->Date)->format('M d, Y') }}</div>
            <div><strong>Receipt#:</strong> {{ $declaration->ReceiptNo }}</div>
        </div>
        ...
        <div class="details">
            <div class="row">
                ...
                <span class="val">{{ $declaration->BL }}</span>
            </div>
            <div class="row">
                <span class="lbl">Declaration No:</span>
                <span class="val">{{ $declaration->DeclarationNo }}</span>
            </div>
            <div class="row">
                <span class="lbl">Description:</span>
                <span class="val">{{ $declaration->ItemDescription }}</span>
            </div>
            <div class="row">
                <span class="lbl">Container Size:</span>
                <span class="val">{{ $declaration->ContainerSize }}</span>
            </div>
            <div class="row">
                <span class="lbl">Agent's Name:</span>
                <span class="val">{{ $declaration->AgentName }}</span>
            </div>
            <div class="row">
                <span class="lbl">Agent's Contact:</span>
                <span class="val">{{ $declaration->AgentContact }}</span>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>Duty Paid</td>
                    <td>{{ number_format($declaration->DutyPaid, 2) }}</td>
                </tr>
                <tr>
                    <td>Declaration Charge — IFO {{ $declaration->DeclarationNo }}</td>
        ...
        <div class="issued">
            <div>ISSUED BY:</div>
            <div class="name">{{ strtoupper($declaration->Username) }}</div>
        </div>
