...
<head>
    ...
    <title>Handling Charge Expenditure — {{ $receiptNo }}</title>
    <style>
        * {
    ...
    <div class="wrapper">
        ...
        <div class="header">
            ...
            <div class="header-info">
                ...
                <div class="tagline">
                    ...
                    Forwarding, Transit, Haulage, Import &amp; Export
                </div>
            </div>
        </div>

        {{-- Banner --}}
        <div class="banner">HANDLING CHARGE EXPENDITURE</div>
        ...
        <div class="details">
            <div class="row">
                ...
                <span class="val">{{ $expense->MainBL }}</span>
            </div>
            <div class="row">
                <span class="lbl">Vessel:</span>
                <span class="val">{{ $expense->VesselName ?? '—' }}</span>
            </div>
            <div class="row">
                <span class="lbl">ETA:</span>
                <span class="val">
                    {{ $expense->ETA ? \Carbon\Carbon::parse($expense->ETA)->format('M d, Y') : '—' }}
                </span>
            </div>
            <div class="row">
                <span class="lbl">Source Account:</span>
                <span class="val">{{ $expense->SourceAccountName }}</span>
            </div>
            <div class="row">
                <span class="lbl">Expenditure A/C:</span>
                <span class="val">{{ $crEntry?->AccountName ?? '—' }}</span>
            </div>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ number_format($expense->Dr, 2) }}</td>
                </tr>
                <tr class="total-row">
        ...
        <div class="issued">
            <div>ISSUED BY:</div>
            <div class="name">{{ strtoupper($expense->Username) }}</div>
        </div>
